...
export function IntegrationsPage() {
  ...
  // Global API Config state from dbEngine
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="p-5 rounded-2xl bg-black/40 border border-white/10 space-y-4 hover:border-primary/30 transition">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <h4 className="text-sm font-bold text-white">Reviews World Master API Key</h4>
                  <p className="text-[11px] text-muted-foreground">App Store &amp; Play Store auto-fetch key</p>
                </div>
              </div>
            ...
            <div>
              <label className="text-xs font-semibold text-neutral-300 mb-1 block">Master API Secret Key</label>
              <div className="relative">
                <input
                  ...
                  className="w-full pl-3 pr-24 py-2.5 rounded-xl bg-black/60 border border-white/10 text-xs font-mono text-white placeholder:text-neutral-500 focus:border-primary focus:outline-none"
                />
                <button
                  type="button"
          ...
          <div className="p-5 rounded-2xl bg-black/40 border border-white/10 space-y-4 hover:border-primary/30 transition">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <h4 className="text-sm font-bold text-white">AI Reply &amp; Insights Engine Token</h4>
                  <p className="text-[11px] text-muted-foreground">Powers automated response &amp; root cause synthesis</p>
                </div>
              </div>
              <span className="text-[10px] font-bold px-2.5 py-0.5 rounded-full bg-emerald-500/10 border border-emerald-500/30 text-emerald-400">
                Connected
              </span>
            </div>

            <div>
              <label className="text-xs font-semibold text-neutral-300 mb-1 block">AI Engine Token</label>
              <div className="relative">
                <input
                  type="password"
                  value={aiApiKey}
          ...
          <div className="p-5 rounded-2xl bg-black/40 border border-white/10 space-y-4 hover:border-primary/30 transition md:col-span-2">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <h4 className="text-sm font-bold text-white">Crisis Alert &amp; Webhook Escalation URL</h4>
                  <p className="text-[11px] text-muted-foreground">Pushed automatically when P1 critical reviews are detected</p>
                </div>
              </div>
              <span className="text-[10px] font-bold px-2.5 py-0.5 rounded-full bg-emerald-500/10 border border-emerald-500/30 text-emerald-400">
                Webhook Active
            ...
            <div className="flex flex-col sm:flex-row items-center gap-2">
              <input
                ...
                className="w-full flex-1 px-3 py-2.5 rounded-xl bg-black/60 border border-white/10 text-xs font-mono text-white placeholder:text-neutral-500 focus:border-primary focus:outline-none"
              />
              <button
                type="button"
                onClick={() => toast.success('Webhook endpoint test payload sent!')}
                className="w-full sm:w-auto px-4 py-2.5 rounded-xl bg-white/10 hover:bg-white/15 text-white font-semibold text-xs transition border border-white/10 shrink-0"
              >
