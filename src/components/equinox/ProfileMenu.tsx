...
export function ProfileMenu({ sessionUser, orgName = 'Equinox Motors India', onLogout, onNavigate }: ProfileMenuProps) {
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      >
        <div className="w-8 h-8 rounded-full border border-white/10 bg-gradient-to-br from-primary to-secondary text-black text-xs font-extrabold flex items-center justify-center shadow-md">
          {initial}
        </div>
      ...
      {open && (
        <div className="absolute right-0 mt-2 w-[300px] z-50 rounded-2xl bg-neutral-950 border border-white/10 shadow-2xl overflow-hidden divide-y divide-white/5">
          <div className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-1.5 mt-1">
                  ...
                  <span className="text-[9px] px-1.5 py-0.5 rounded border border-emerald-500/30 text-emerald-400 bg-emerald-500/10 font-bold flex items-center gap-0.5">
            ...
            <div className="mt-3 flex items-center gap-2.5 p-2 rounded-xl bg-black/40 border border-white/5">
              ...
              <div className="flex-1 min-w-0 text-left">
                ...
                <div className="text-[10px] uppercase tracking-wider text-muted-foreground font-semibold">Enterprise Plan</div>
              </div>
            </div>
          </div>
            ...
            {ITEMS.map((item) => {
              ...
              return (
                <button
                  ...
                  className="w-full flex items-center gap-3 px-4 py-2 text-xs text-neutral-200 hover:bg-white/5 hover:text-primary transition group"
                >
                  <Icon className="w-4 h-4 text-muted-foreground group-hover:text-primary shrink-0" />
                  <div className="flex-1 text-left min-w-0">
                    <div className="font-semibold">{item.label}</div>
                    <div className="text-[10px] text-muted-foreground truncate">{item.hint}</div>
                  </div>
          ...
          <div className="p-2">
            <button
              ...
              className="w-full flex items-center gap-3 px-3 py-2 rounded-xl text-xs text-neutral-300 hover:bg-rose-500/10 hover:text-rose-400 font-semibold transition"
            >
